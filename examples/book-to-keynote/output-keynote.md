...
In 2008, Cass Sunstein and Richard Thaler publish research on organ donation rates. In countries where you have to opt **in** to donate, donation rates are around 15%. In neighboring countries with identical culture, identical wealth, identical everything — but where you have to opt **out** — donation rates are over 90%.
...
*This is an illustrative, AI-assisted editorial sample based on a book and a synthetic brief. Its personal anecdotes and product metrics are fictional demonstrations, not customer results. See [generation-notes.md](generation-notes.md) for the evidence boundary.*
